...
const ServicesPage = () => {
  ...
  // Apenas CANDIDATE pode acessar esta página
  if (user && user.role !== "CANDIDATE") {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="bg-white border border-gray-200 rounded-2xl p-12 shadow-sm">
          <div className="text-5xl mb-4">🔒</div>
          <h2 className="text-xl font-black text-gray-900 mb-2">Área exclusiva para profissionais</h2>
          <p className="text-gray-500 text-sm">Esta página é destinada a profissionais que buscam serviços ou empregos.</p>
          <button onClick={() => setPage("home")} className="mt-6 bg-teal-700 text-white font-bold px-6 py-3 rounded-xl text-sm hover:bg-teal-800 transition-colors">Voltar ao início</button>
        </div>
      </div>
    );
  }
