...
const ServiceCard = ({ job }) => {
  ...
  const submitProposal = async () => {
    ...
    try {
      ...
      // Atualizar estado local com a proposta (garante sucesso independente do chat)
      setDb(prev => ({
        ...prev,
      ...
      // Tentar criar conversa — não bloqueia se a tabela ainda não existir
      try {
        ...
        console.warn("Conversa não criada (execute a migração v3):", convErr.message);
      }
