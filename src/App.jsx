...
const VerificationPage = () => {
  ...
  // Inicia a verificação: chama a Edge Function que cria a sessão no Didit
  const startVerification = async () => {
    ...
    try {
      ...
      // Redireciona para o Didit (funciona em desktop e mobile)
      // Salva a URL no sessionStorage para o caso de o usuário voltar
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-8">
      ...
      <button onClick={startVerification} disabled={loading || !lgpdConsent}
        ...
        {loading ? "Iniciando verificação..." : "🚀 Iniciar verificação gratuita"}
      </button>
