...
export default function EmpregaFacilV2() {
  ...
  // ── Polling global de fallback (caso Realtime esteja desabilitado no Supabase) ──
  // Atualiza jobs, proposals e reviews a cada 15s. Garante sincronia sem depender de Realtime.
  useEffect(() => {
    const poll = setInterval(async () => {
      try {
