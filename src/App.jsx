  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex bg-gray-100 rounded-xl p-1 gap-1 overflow-x-auto">
        {tabs.map(t => (
          <button key={t.key} onClick={() => setTab(t.key)}
            className={`flex items-center gap-1.5 whitespace-nowrap px-3 py-2 rounded-lg text-xs font-bold transition-all ${tab === t.key ? "bg-white shadow text-teal-700" : "text-gray-500"}`} style={{flexShrink:0}}>
            {t.label}
            ...
            <div className="p-4">
              ...
              <div className="flex flex-wrap gap-2" style={{marginTop:"4px"}}>
                ...
                <button onClick={async () => {
                  if (!window.confirm("Apagar esta vaga permanentemente?")) return;
        ...
        return (
          <div key={job.id} className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm space-y-3">
            ...
            <div className="flex flex-wrap gap-2" style={{paddingTop:"8px"}}>
              ...
              <button onClick={async () => {
                if (!window.confirm("Apagar este pedido permanentemente?")) return;
                try {
