                ...
                {myReviews.map(r => (
                  <div key={r.id} className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
                    <div className="flex items-start justify-between gap-3 mb-2">
                      <div className="flex items-center gap-2">
                        <div className="w-9 h-9 bg-teal-100 rounded-full flex items-center justify-center text-teal-700 font-black text-sm flex-shrink-0">{r.reviewerName?.[0]?.toUpperCase()||"?"}</div>
                        <div>
                          <p className="font-bold text-gray-900 text-sm">{r.reviewerName}</p>
