...
const DIDIT_WORKFLOW_ID = "32487f70-8bca-4d80-bfe9-fcc2e22ac4a9";
...
const VerificationPage = () => {
  ...
  const startVerification = async () => {
    ...
    try {
      ...
      // Abre o fluxo KYC do Didit em nova janela (hospedado pelo Didit)
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-10 shadow-sm">
        ...
        {!polling && (
          <button onClick={() => setPolling(true)}
            className="w-full border border-teal-300 text-teal-700 font-bold py-3 rounded-xl text-sm hover:bg-teal-50 transition-colors mb-3">
