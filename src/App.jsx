      ...
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1 mt-1">
            {stars(pro.rating)}
            <span className="text-xs font-semibold text-gray-700 ml-1">{pro.rating > 0 ? pro.rating.toFixed(1) : "—"}</span>
        ...
        <div className="space-y-3">
          ...
          {myProposals.length === 0 ? (
            ...
            const handleComplete = async () => {
              const ok = await requestConfirm({ title: "Marcar como concluída?", message: "A proposta deixará de aparecer na listagem geral.", confirmLabel: "Concluir", confirmClass: "bg-teal-700 hover:bg-teal-800 text-white" });
              if (!ok) return;
              try {
              ...
              } catch (e) { setError("Erro ao concluir: " + e.message); setTimeout(() => setError(""), 4000); }
            };
              ...
              <div className="flex flex-wrap gap-2" style={{marginTop:"4px"}}>
                {job.status === "OPEN" && (
                  <button onClick={() => markComplete(job)}
                    className="flex-1 px-3 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-xs font-bold transition-colors text-center" style={{minWidth:"110px"}}>
                    ✅ Concluir vaga
                  </button>
                )}
